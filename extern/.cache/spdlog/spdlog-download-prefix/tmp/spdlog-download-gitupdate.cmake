...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v1.1.0
  WORKING_DIRECTORY "/Users/ziyizhang/Projects/ShellMesh/Conforming-tet-shell/extern/spdlog"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/ziyizhang/Projects/ShellMesh/Conforming-tet-shell/extern/spdlog/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/ziyizhang/Projects/ShellMesh/Conforming-tet-shell/extern/spdlog/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
