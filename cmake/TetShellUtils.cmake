...
function(tet_shell_copy_headers)
    foreach(filepath IN ITEMS ${ARGN})
        get_filename_component(filename "${filepath}" NAME)
        if(${filename} MATCHES ".*\.(hpp|h|ipp)$")
            configure_file(${filepath} ${PROJECT_BINARY_DIR}/include/tetshell/${filename})
        endif()
    endforeach()
endfunction()

# Set source group for IDE like Visual Studio or XCode
function(tet_shell_set_source_group)
	foreach(filepath IN ITEMS ${ARGN})
...
function(tet_shell_add_application APP_SOURCE)
	# Add executable
